      ...
      <div className="fixed inset-0">
        ...
        {!isMobile && (
          <div className="hidden md:block">
            <motion.div
              className="absolute top-0 -left-40 w-96 h-96 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 dark:opacity-10"
              animate={{ x: [0, 50, 0], y: [0, 25, 0] }}
              transition={{ duration: 20, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
              className="absolute top-0 -right-40 w-96 h-96 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 dark:opacity-10"
              animate={{ x: [0, -50, 0], y: [0, 40, 0] }}
              transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
              className="absolute -bottom-40 left-1/2 w-96 h-96 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 dark:opacity-10"
        ...
        {/* Cute floating elements - Reduced count for performance */}
        {floatingEmojis.slice(0, isMobile ? 3 : 6).map((emoji, i) => (
          <motion.div
            key={i}
            ...
            <motion.div style={{ opacity, scale }} className="relative">
              ...
              {!isMobile && (
                <div className="hidden md:block">
                  ...
                  <div className="absolute -bottom-20 -right-20 text-6xl animate-float-delayed">💝</div>
                </div>
              )}
              ...
              {[
                ...
                >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-pink-100 dark:bg-pink-900/50 flex items-center justify-center text-pink-500 text-sm md:text-base">
                      💕
                    </div>
                  </div>
                </motion.div>
              ...
              {[
                ...
                >
                  <div className="bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 md:p-8 text-center relative z-10 border border-white/50 dark:border-white/10 shadow-xl">
                    <div className={`w-20 h-20 md:w-24 md:h-24 mx-auto mb-4 md:mb-6 rounded-full bg-gradient-to-r ${step.gradient} flex items-center justify-center text-3xl md:text-4xl shadow-lg`}>
                      {step.icon}
                    </div>
                    ...
                    {idx < 2 && !isMobile && (
                      <div className="hidden md:block absolute -right-6 top-1/2 transform -translate-y-1/2">
                        <div className="text-2xl md:text-3xl text-pink-400 animate-pulse">💕</div>
                      </div>
                    )}
                  </div>
                </motion.div>
        ...
        <footer className="py-8 md:py-12 px-4 border-t border-pink-200 dark:border-pink-900/30">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400 text-xs md:text-sm pt-6 md:pt-8 border-t border-pink-200 dark:border-pink-900/30">
              ...
              <p className="mt-1 md:mt-2">© 2025 SurpriseBox. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
