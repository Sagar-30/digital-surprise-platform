...
//   const handleAnswer = (selectedOptionValue) => {
//     setSelectedOption(selectedOptionValue);
//     const isAnswerCorrect = selectedOptionValue === questions[currentQuestion].correct;
    
//     // Add visual feedback
//     setTimeout(() => {
//       const newAnswers = [...answers, selectedOptionValue];
  ...
  const handleAnswer = (selectedOptionValue, selectedIndex) => {
    ...
    setTimeout(() => {
      ...
      if (currentQuestion + 1 < questions.length) {
        ...
        const finalScore = newAnswers.filter((answer, idx) => answer === questions[idx]?.correct).length;
          ...
          {isPerfect ? (
            ...
            >
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
                {score === questions.length ? (
                  "✨ Perfect! Moving to the next surprise..."
                ) : (
                  "💝 Take your time to learn more about each other!"
                )}
              </p>
            </motion.div>
          )}
